                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <h2 class="text-uppercase">hermit purple</h2>
                                    <p class="item-intro text-muted">Manieur: Joseph Joestar.</p>
                                    <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/Joseph_Joestar_(JoJo)_Purple_Hermit_on_camera.gif" alt="" />
                                    <p>Pouvoir
                                        Hermit Purple est un stand qui se contrôle à mi-distance, bien qu'il soit plus efficace en l'utilisant de loin.
                                        <ul>

                                       <li> Images psychiques : Joseph peut imprimer des images venant d'endroits éloignés (pour espionner un adversaire ou repérer une personne en particulier), pour ce faire, il doit détruire un appareil photo ou investir une télévision avec Hermit Purple.
                                        </li> <li> Lecture psychique :  La technique précédente sert également à lire les pensées de la personne que Joseph aura désigné, afin de lui soutirer des informations importantes.
                                            
                                       <li> Extension : Joseph peut étendre Hermit Purple comme une corde, pour aggriper des objets ou ligoter des personnes.</li>
                                       <li>Combinaison avec l'Onde : Et tant que manieur d'Onde, Joseph peut se servir d'Hermit Purple pour faire circuler l'Onde, comme une extension de son corps.</li> 
                                       <li> Carte : Il peut dessiner un plan d'un endroit précis en utilisant n'importe quelle matière poudreuse.</li></p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">star platinum</h2>
                                    <p class="item-intro text-muted">Manieur: Jotaro Kujo.</p>
                                    <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/star platinum.gif" alt="" />
                                    ...
                                    <ul class="list-inline">
                                        <li>Date: January 2020</li>
                                        <li>Star Platinium</li>
                                        <li>Manieur: Jotaro Kujo</li>
                                    </ul>
                                    <button class="btn btn-primary" data-dismiss="modal" type="button">
                                        <i class="fas fa-times mr-1"></i>
                                        Close Project
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">Crazy Diamond</h2>
                                    <p class="item-intro text-muted">Manieur: Josuke Higashikata</p>
                                    <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/Crazy_Diamond_Powa.gif" alt="" />
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">Gold Experience</h2>
                                    <p class="item-intro text-muted">Manieur: Giorno Giorno</p>
                                    <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/golde_experience.gif" alt="" />
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">Stone Free</h2>
                                    <p class="item-intro text-muted">Manieuse:Jolyne Cujoh</p>
                                    <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/stone_modal.jpg" alt="" />
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/tusk_animation.gif" alt="" />
...
Sa force dans les échanges de mêlée par rapport aux autres stands a été davantage démontrée lors de la brève rencontre avec le stand de Yotsuyu Yagiyama , I Am a Rock . Malgré sa volée de frappes rapides, Soft & Wet l'a facilement évité et surmonté avec une seule frappe articulée `` Ora ''. 

<b>Génération de bulles </b>
Soft & Wet génère des bulles flottantes incrustées d'étoiles, qui doivent entrer en contact avec sa cible pour fonctionner efficacement. Cependant, Josuke peut contrôler où les bulles peuvent voler, lui permettant de les envoyer là où elles sont nécessaires. Les bulles sont en fait constituées de minuscules cordons qui vibrent à des vitesses très élevées, leur donnant l'apparence de sphères.

Josuke profite souvent directement de ses bulles et de leurs propriétés. Les bulles ont un pouvoir de levage, permettant à Josuke d'envelopper d'autres comme Yotsuyu Yagiyama dans une bulle géante et de les soulever dans les airs,  ainsi que de l'aider à atteindre des points de vue. Josuke s'est également enveloppé et ses alliés de bulles géantes pour profiter de leur protection situationnelle. Après avoir subi un échange équivalent avec Yoshikage Kira, les bulles produites par Soft & Wet ont acquis des aspects de sa propre capacité de Stand de génération de bulles . En tant que tel, les bulles de Soft & Wet sont divisées en une «moitié Josefumi» et une «moitié Kira» distinctes, avec une couture visible reliant les deux portions. 

En plus de sa capacité régulière de génération de bulles sur support, Soft & Wet est capable de faire des bulles à partir de liquides existants. Cependant, ces bulles ne peuvent être maintenues que brièvement et n'ont pas les capacités de celles générées par le Stand lui-même.

Au fil de l'histoire, Josuke a développé cette capacité. Au début de l'histoire, il utilisait souvent une bulle, mais plus tard, il est montré en conjurant des dizaines et des dizaines avec une rafale rapide de grèves.

Plus tard dans la série, il est révélé que les bulles sont en fait des fils de rotation qui se forment dans une sphère, ce qui la relierait au Spin .

<b>Pillage:</b>
La capacité signature de Soft & Wet est de "voler quelque chose à un objet] et de le prendre pour lui-même", ce qui fonctionne en conjonction avec les bulles. Josuke peut ainsi voler des aspects ou des propriétés des êtres inanimés et vivants. Les dites propriétés semblent également être des objets plus petits provenant d'un objet plus grand. Les exemples comprennent:
<ul><li>Température: en combattant les coléoptères avec Jobin, Josuke a pris une partie de la température de sa brosse et du Rosenbergi de Joubin pour vérifier la quantité de chaleur en plaçant cette température dans un thermomètre à proximité.</li>
<li>La vue d'un être humain: Après l'éclatement prèsJoshu yeux de, bulle de Josuke stores complètement Joshu pendant quelques secondes, faisant apparaître que les yeux de Joshu ont surgi.</li>
<li>L'eau contenue dans le corps d'un humain: Avec une bulle, Josuke perce secrètement plusieurs trous de ~ 5 mm dans le corps d'une femme afin de la vider rapidement de l'eau et provoquer la soif.</li>
<li>Son: Josuke vole le son d'un mur ou d'un interrupteur d'éclairage, empêchant tout bruit qui aurait été causé en le cassant ou en l'éteignant.</li>
<li>Ses propres poils sur le visage: Josuke utilise Soft &amp; Wet pour se raser le visage lorsque Hato et Joshu sont également dans la salle de bain. Les bulles de Soft &amp; Wet dans la mousse à raser apparaissent sur les visages de Hato et Joshu, plantant les cheveux de Josuke sur leurs visages à la place.</li>
<li>La fourrure d'un chat: Apparemment sans douleur, Josuke enlève la majorité de la fourrure d'un chat vivant et la déplace, sous la forme d'un chat, afin d'obscurcir la vue d'une caméra de sécurité. </li>
<li>Friction: Josuke supprime le frottement d'un sol, créant une surface glissante semblable à de la glace.</li>
<li>Odeur: Josuke emprisonne une odeur et diverses dans une bulle et l'a attachée à son ennemi Born This Way.Lorsque la bulle éclate, il peut retrouver l'utilisateur du Stand par l'odeur et le son.</li>
<li>Petits objets: Josuke, en combattant les frères A. Phex, a rempli ses bulles de vis et d'écrous pour se déclencher en cas d'éclatement.</li></ul></p>
                                    <ul class="list-inline">
                                        <li>Date: January 2020</li>
                                        <li>Client: Window</li>
                                        <li>Category: Photography</li>
